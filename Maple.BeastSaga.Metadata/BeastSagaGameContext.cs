...
namespace Maple.BeastSaga.Metadata
{
    ...
    [ContextMemberMetadata<FoodItemData>]
    ...
    //  [ContextMemberMetadata<LifeType>]
    [ContextMemberMetadata<LoadDataSet>]
    [ContextMemberMetadata<MakeDataSet>]
    [ContextMemberMetadata<OpenUIManager>]
    [ContextMemberMetadata<PlayerCharacter>]
    [ContextMemberMetadata<PlayerChong>]
    [ContextMemberMetadata<PlayerChongPot>]
    [ContextMemberMetadata<PlayerData>]
    [ContextMemberMetadata<PlayerDataManager>]
    [ContextMemberMetadata<PlayerEquipData>]
    [ContextMemberMetadata<PlayerFriendDataLogic>]
