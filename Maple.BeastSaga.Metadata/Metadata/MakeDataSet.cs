...
namespace Maple.BeastSaga.Metadata
{
    ...
    /// </summary>
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassParentMetadataAttribute<Maple.MonoGameAssistant.MetadataExtensions.MetadataCollector.ClassMetadataCollector<Ptr_MakeDataSet>, Ptr_MakeDataSet>]
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassModelMetadataAttribute("Model.Runtime", "", "MakeDataSet", "MakeDataSet")]
    public partial class MakeDataSet
    {
        [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
        public unsafe readonly partial struct Ptr_MakeDataSet(System.IntPtr ptr) : Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.IPtrMetadata
        {
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.SysInt)]
            readonly System.IntPtr m_Pointer = ptr;
            public System.IntPtr Ptr => m_Pointer;

            public static implicit operator Ptr_MakeDataSet(System.IntPtr ptr) => new Ptr_MakeDataSet(ptr);
            public static implicit operator System.IntPtr(Ptr_MakeDataSet ptr) => ptr.m_Pointer;
            public static implicit operator bool (Ptr_MakeDataSet ptr) => ptr.m_Pointer != System.IntPtr.Zero;
        }

        /// <summary>
        /// class ["Model.Runtime".""."MakeDataSet"]
        /// </summary>
        partial struct Ptr_MakeDataSet
        {
            /// <summary>
...
*/
            ...
            /// <summary>
            /// 0x20 ItemDataDictionary _AwardItems
            /// class ["Model.Runtime".""."ItemDataDictionary"]
            /// </summary>
            /// <returns>class ItemDataDictionary</returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_AwardItems", "ItemDataDictionary")]
            public partial nint _AWARD_ITEMS { get; set; } 
*/

            /// <summary>
            /// 0x28 EquipDataDictionary _AwardEquips
            /// class ["Model.Runtime".""."EquipDataDictionary"]
            /// </summary>
            /// <returns>class EquipDataDictionary</returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_AwardEquips", "EquipDataDictionary")]
            public partial nint _AWARD_EQUIPS { get; set; } 
*/

            /// <summary>
            /// 0x30 ItemDataDictionary _NeedItems
            /// class ["Model.Runtime".""."ItemDataDictionary"]
            /// </summary>
            /// <returns>class ItemDataDictionary</returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_NeedItems", "ItemDataDictionary")]
            public partial nint _NEED_ITEMS { get; set; } 
*/

            /// <summary>
            /// 0x38 EquipDataDictionary _NeetEquips
            /// class ["Model.Runtime".""."EquipDataDictionary"]
            /// </summary>
            /// <returns>class EquipDataDictionary</returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_NeetEquips", "EquipDataDictionary")]
            public partial nint _NEET_EQUIPS { get; set; } 
*/
...
*/
            ...
            /// <summary>
            /// 0x48 MakeType _MakeType
            /// enum ["Model.Runtime".""."MakeType"]
            /// </summary>
            /// <returns>enum MakeType</returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_MakeType", "MakeType")]
            public partial MakeType _MAKE_TYPE { get; set; } 
*/
        }
