...
using static Maple.BeastSaga.Metadata.InKangFuDataSet;

namespace Maple.BeastSaga.Metadata
{
    /// <summary>
    /// class ["Model.Runtime".""."GameSetDataManager"]
    ...
    /// </summary>
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassParentMetadataAttribute<Maple.MonoGameAssistant.MetadataExtensions.MetadataCollector.ClassMetadataCollector<Ptr_GameSetDataManager>, Ptr_GameSetDataManager>]
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassModelMetadataAttribute("Model.Runtime", "", "GameSetDataManager", "GameSetDataManager")]
    public partial class GameSetDataManager
    {
        [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
        public unsafe readonly partial struct Ptr_GameSetDataManager(System.IntPtr ptr) : Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.IPtrMetadata
        {
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.SysInt)]
            readonly System.IntPtr m_Pointer = ptr;
            public System.IntPtr Ptr => m_Pointer;

            public static implicit operator Ptr_GameSetDataManager(System.IntPtr ptr) => new Ptr_GameSetDataManager(ptr);
            public static implicit operator System.IntPtr(Ptr_GameSetDataManager ptr) => ptr.m_Pointer;
            public static implicit operator bool(Ptr_GameSetDataManager ptr) => ptr.m_Pointer != System.IntPtr.Zero;
        }

        /// <summary>
        /// class ["Model.Runtime".""."GameSetDataManager"]
        /// </summary>
        partial struct Ptr_GameSetDataManager
        {
            /// <summary>
...
*/
            /// <summary>
            /// 0x0 GameSetDataManager _Instance
            /// class ["Model.Runtime".""."GameSetDataManager"]
            /// </summary>
            /// <returns>class GameSetDataManager</returns>
            /*
           [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("_Instance", "GameSetDataManager")]
...
*/
            ...
            /// <summary>
            /// 0x18 System.Collections.Generic.List<EquipDataSet> EquipData
            /// class ["mscorlib"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<EquipDataSet></returns>

            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("EquipData", "System.Collections.Generic.List<EquipDataSet>")]
            public partial PMonoList_BeastSaga<EquipDataSet.Ptr_EquipDataSet> EQUIP_DATA { get; }


            /// <summary>
            /// 0x20 System.Collections.Generic.List<ItemDataSet> ItemData
            /// class ["mscorlib"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<ItemDataSet></returns>

            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("ItemData", "System.Collections.Generic.List<ItemDataSet>")]
            public partial PMonoList_BeastSaga<ItemDataSet.Ptr_ItemDataSet> ITEM_DATA { get; }


            /// <summary>
            /// 0x28 System.Collections.Generic.List<InKangFuDataSet> InKangFuData
            /// class ["mscorlib"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<InKangFuDataSet></returns>

            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("InKangFuData", "System.Collections.Generic.List<InKangFuDataSet>")]
            public partial PMonoList_BeastSaga<InKangFuDataSet.Ptr_InKangFuDataSet> IN_KANG_FU_DATA { get; }


            /// <summary>
            /// 0x30 System.Collections.Generic.List<KangFuDataSet> KangFuData
            /// class ["mscorlib"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<KangFuDataSet></returns>

            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("KangFuData", "System.Collections.Generic.List<KangFuDataSet>")]
            public partial PMonoList_BeastSaga<KangFuDataSet.Ptr_KangFuDataSet> KangFuData { get; }


            /// <summary>
            /// 0x38 System.Collections.Generic.List<UniqueSkillDataSet> UniqueSkillData
            /// class ["mscorlib"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<UniqueSkillDataSet></returns>

            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("UniqueSkillData", "System.Collections.Generic.List<UniqueSkillDataSet>")]
            public partial PMonoList_BeastSaga<UniqueSkillDataSet.Ptr_UniqueSkillDataSet> UNIQUE_SKILL_DATA { get; }
